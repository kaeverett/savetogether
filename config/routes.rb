ActionController::Routing::Routes.draw do |map|
  ...
  #Routes for static pages using StaticPagesController
  map.with_options :controller => 'root' do |root|
    root.about_us 'about_us', :action => 'about_us'
    root.faq 'faq', :action => 'faq'
    root.why_savings 'why_savings', :action => 'why_savings'
  end

  map.resource  :session
  map.member '/member/:id', :controller => "user/profiles", :action => 'show'
